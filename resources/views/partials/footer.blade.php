...
<footer class="main-footer">
    <div class="container-wide">
        <div class="footer-grid">
            <!-- Brand column -->
            <div>
                <div class="flex-center" style="gap:10px;margin-bottom:16px;">
                ...
                <div class="footer-social">
                    <a href="https://instagram.com/bugyltrail" class="social-icon social-icon-ig">
                    ...
                    <a href="mailto:info@bugyltrail.kz" class="social-icon social-icon-mail">
            ...
            <!-- Event links -->
            <div>
                <h4 class="footer-heading">{{ __('Event') }}</h4>
                <ul class="footer-links-list">
                    <li><a href="#about" class="footer-link">{{ __('About the Race') }}</a></li>
                    <li><a href="#routes" class="footer-link">{{ __('Distances & Prices') }}</a></li>
                    <li><a href="#gallery" class="footer-link">{{ __('Photo Gallery') }}</a></li>
                    <li><a href="#partners" class="footer-link">{{ __('Partners') }}</a></li>
                    <li><a href="#" class="footer-link">{{ __('Results Archive') }}</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="footer-links-list" style="gap:14px;">
                    <li class="flex-center" style="gap:8px;">
                        ...
                        <a href="mailto:info@bugyltrail.kz" class="footer-link" style="font-size:.82rem;">info@bugyltrail.kz</a>
                    </li>
                    <li class="flex-center" style="gap:8px;">
                        ...
                        <a href="https://instagram.com/bugyltrail" class="footer-link" style="font-size:.82rem;">@bugyltrail</a>
                    </li>
        ...
        <div class="footer-bottom">
            <p class="footer-copy">© 2025 Bugyly Trail. {{ __('All rights reserved.') }}</p>
            <div class="footer-legal-links">
                <a href="#" class="footer-legal-link">{{ __('Privacy Policy') }}</a>
                <a href="#" class="footer-legal-link">{{ __('Terms of Participation') }}</a>
                <a href="#" class="footer-legal-link">{{ __('Cookie Settings') }}</a>
            </div>
        </div>
    </div>
</footer>
